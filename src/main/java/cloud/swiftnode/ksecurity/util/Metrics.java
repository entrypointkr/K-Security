...
public class Metrics {
    ...
    public JSONObject getPluginData() {
        ...
        data.put("pluginName", pluginName); // Append the getName of the plugin
    ...
    private JSONObject getServerData() {
        ...
        int playerAmount = Static.getOnlinePlayers().length;
        ...
        String osName = System.getProperty("os.getName");
    ...
    public enum Country {
        ...
        /**
         * Gets the getName of the country.
         *
         * @return The getName of the country.
         */
