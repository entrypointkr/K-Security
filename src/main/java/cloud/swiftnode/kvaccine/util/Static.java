...
import cloud.swiftnode.kvaccine.abstraction.executor.PunishSpamExecutor;
...
public class Static {
    public static void runTaskAsync(Runnable runnable) {
        Bukkit.getScheduler().runTaskAsynchronously(KVaccine.INSTANCE, runnable);
    }

    public static void runTaskLaterAsync(Runnable runnable, long delay) {
        Bukkit.getScheduler().runTaskLaterAsynchronously(KVaccine.INSTANCE, runnable, delay);
    }

    public static void runTaskTimerAsync(Runnable runnable, long delay, long period) {
        Bukkit.getScheduler().runTaskTimerAsynchronously(KVaccine.INSTANCE, runnable, delay, period);
    }

    public static void runTask(Runnable runnable) {
        Bukkit.getScheduler().runTask(KVaccine.INSTANCE, runnable);
    }
    ...
    public static String getVersion() {
        return KVaccine.INSTANCE.getDescription().getVersion();
    }

    public static FileConfiguration getConfig() {
        return KVaccine.INSTANCE.getConfig();
    }
