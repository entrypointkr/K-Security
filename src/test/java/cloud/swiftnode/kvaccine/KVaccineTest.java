...
import cloud.swiftnode.kvaccine.abstraction.MockPlayer;
import cloud.swiftnode.kvaccine.abstraction.MockPlugin;
import cloud.swiftnode.kvaccine.abstraction.MockServer;
import cloud.swiftnode.kvaccine.listener.PlayerListener;
import cloud.swiftnode.kvaccine.listener.ServerListener;
import cloud.swiftnode.kvaccine.util.StaticUtil;
 ...
 */
public class KVaccineTest {
    @Before
    public void initTest() throws NoSuchFieldException, IllegalAccessException {
        // Injection
        Field serverField = Bukkit.class.getDeclaredField("server");
        Field instField = KVaccine.class.getDeclaredField("INSTANCE");
